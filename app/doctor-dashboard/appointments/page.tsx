                        ...
                        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-400 min-w-[700px]">
                          <thead className="bg-gray-50 dark:bg-gray-900/50 text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                            <tr>
                              ...
                              <th className="px-5 py-3.5 font-medium w-36">Time Slot</th>
                            ...
                            {apts.map((apt) => (
                              <tr key={apt.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/80 transition-colors">
                                ...
                                <td className="px-5 py-4 font-medium text-gray-700 dark:text-gray-300">
                                  <div className="flex items-center gap-1.5 text-xs font-semibold text-cyan-700 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-900/30 px-2.5 py-1 rounded-md w-fit">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-gray-300 px-4 py-3 font-semibold text-gray-800 w-36">Time Slot</th>

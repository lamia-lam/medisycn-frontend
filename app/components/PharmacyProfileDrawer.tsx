...
export function PharmacyProfileDrawer({
  isOpen,
  onClose,
}: PharmacyProfileDrawerProps) {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white dark:bg-gray-800 shadow-2xl z-[70] overflow-y-auto flex flex-col transition-transform transform translate-x-0">
        <div className="sticky top-0 bg-gradient-to-r from-teal-600 to-cyan-500 text-white p-6 border-b border-gray-200 dark:border-gray-700 z-10 shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">Pharmacy Profile</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex items-center gap-4">
            <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center text-3xl font-semibold relative overflow-hidden">
              ...
              <button className="absolute bottom-0 right-0 w-6 h-6 bg-white dark:bg-gray-800 text-teal-600 dark:text-teal-400 rounded-full flex items-center justify-center shadow-md hover:bg-gray-50 transition-colors">
        ...
        <div className="p-6 flex-1 bg-white dark:bg-gray-800">
          {activeTab === "profile" && (
            <div className="space-y-5">
              ...
              <div>
                <label className={labelClass}>Pharmacy License</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Enter valid pharmacy license"
                  />
                </div>
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full bg-teal-600 hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed text-white py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 shadow-sm"
                >
          ...
          {activeTab === "password" && (
            <div className="space-y-5">
              ...
              <div className="pt-2">
                <button className="w-full bg-teal-600 hover:bg-teal-700 text-white py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 shadow-sm">
